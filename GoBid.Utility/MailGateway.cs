...
namespace GoBid.Utility
{
    ...
    {
       public static string Sendmail(string smtpusername, string smtppassword, int smtpclientport,  string smtpclienthost, string Senderemail, string senderpassword, string Receivermail, string mailsubject, string mailmessage)
        {
            string Error;
            ...
            smtpclient.Host = smtpclienthost; // setting the smtp server it is sending the email from e.g gmail, yahoo, hotmail etc.
